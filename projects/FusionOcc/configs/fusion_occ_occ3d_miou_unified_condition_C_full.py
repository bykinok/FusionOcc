...
#   - ALL occupied voxels: always supervised (force mask_camera=1) regardless
...
# so condition_C_full is implemented by forcing mask_camera=1 for all occupied
# voxels in LoadOccGTFromFile.
...
# regardless of distance; free voxels obey original mask_camera.
train_pipeline = [
    dict(
...
work_dir = './work_dirs/fusion_occ_occ3d_miou_unified_condition_C_full'
