...
# -----------------------------------------------------------------------
# Ablation: condition_D (free-only distance mask)
#   - Free voxels < 20 m from ego: always supervised (force mask_camera=1)
#     regardless of camera visibility.
#   - Free voxels >= 20 m: obey original mask_camera.
...
# so condition_D is implemented by forcing mask_camera=1 for near free
...
# Condition D: free voxels within 20 m force mask_camera=1 (always supervised);
# occupied voxels and far free voxels obey original mask_camera.
train_pipeline = [
    dict(
...
work_dir = './work_dirs/fusion_occ_occ3d_miou_unified_condition_D'
