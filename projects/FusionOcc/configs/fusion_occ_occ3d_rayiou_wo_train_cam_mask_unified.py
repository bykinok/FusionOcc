...
#
# fusion_occ_occ3d_rayiou_wo_train_cam_mask_unified.py
#
# Based on fusion_occ_occ3d_miou_wo_train_cam_mask_unified.py
#
# Camera mask policy:
...
use_mask_train = False  # 학습 시 camera mask 미사용
...
model = dict(
    ...
    loss_occ=dict(
        ...
        use_sigmoid=False,
        loss_weight=1.0),
    use_mask=use_mask_train,  # 학습 시 camera mask 미사용 (False)
)
...
# RayIoU 평가: camera mask 미사용 (use_image_mask=False)
val_evaluator = dict(
...
work_dir = './work_dirs/fusion_occ_occ3d_rayiou_wo_train_cam_mask_unified'
