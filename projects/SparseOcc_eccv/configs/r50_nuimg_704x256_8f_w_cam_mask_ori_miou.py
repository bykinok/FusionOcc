"""SparseOcc_ori r50 NuScenes 704x256 8frames 설정 (mmengine 형식) — w/ train camera mask.

원본: projects/SparseOcc_eccv/configs/r50_nuimg_704x256_8f_wo_cam_mask_ori_miou.py
변경 사항 (wo_cam_mask → w_cam_mask):
  ...
  4. [work_dir] sparseocc_eccv_r50_256x704_8f_w_cam_mask_ori_miou
...
log_level = 'INFO'
work_dir = 'work_dirs/sparseocc_eccv_r50_256x704_8f_w_cam_mask_ori_miou'
