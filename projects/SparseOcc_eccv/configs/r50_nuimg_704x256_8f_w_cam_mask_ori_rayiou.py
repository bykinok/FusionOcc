"""SparseOcc_ori r50 NuScenes 704x256 8frames 설정 (mmengine 형식) — w/ train camera mask, RayIoU 평가.

원본: projects/SparseOcc_eccv/configs/r50_nuimg_704x256_8f_wo_cam_mask_ori_rayiou.py
변경 사항 (wo_cam_mask → w_cam_mask):
  ...
  3. [train_pipeline/Collect3D] mask_camera를 keys에 추가
  4. [work_dir] sparseocc_eccv_r50_256x704_8f_w_cam_mask_ori_rayiou
...
# 학습 시 mask_camera 로드 + Collect3D keys에 포함
train_pipeline = [
...
log_level = 'INFO'
work_dir = 'work_dirs/sparseocc_eccv_r50_256x704_8f_w_cam_mask_ori_rayiou'
