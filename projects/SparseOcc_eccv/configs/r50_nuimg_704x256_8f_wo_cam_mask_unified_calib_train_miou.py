"""SparseOcc_unified r50 NuScenes 704x256 8frames 설정 (mmengine 형식) — calib_train.
...
# ── Optimizer (unified 변경 사항: accumulative_counts=4) ─────────────────────
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(
        type='AdamW',
...
log_level = 'INFO'
work_dir = 'work_dirs/sparseocc_eccv_r50_256x704_8f_wo_cam_mask_unified_miou'
