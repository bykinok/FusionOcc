"""SparseOcc_unified r50 NuScenes 704x256 8frames — wo/ train camera mask + Depth SV (mmengine 형식) — RayIoU 평가.

원본: projects/SparseOcc_eccv/configs/r50_nuimg_704x256_8f_wo_cam_mask_unified_w_DepthSV_miou.py
변경 사항 (miou → rayiou):
  1. [val_evaluator] eval_metric='miou' → 'rayiou' (RayIoU@1/2/4 평가)
  2. [work_dir] sparseocc_eccv_r50_256x704_8f_wo_cam_mask_unified_w_DepthSV_rayiou
...
log_level = 'INFO'
work_dir = 'work_dirs/sparseocc_eccv_r50_256x704_8f_wo_cam_mask_unified_w_DepthSV_rayiou'
