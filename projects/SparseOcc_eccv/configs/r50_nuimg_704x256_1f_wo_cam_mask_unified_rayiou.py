"""SparseOcc_unified r50 NuScenes 704x256 1frame 설정 (mmengine 형식) — temporal ablation, RayIoU 평가.

원본: projects/SparseOcc_eccv/configs/r50_nuimg_704x256_8f_wo_cam_mask_unified_rayiou.py
변경 사항 (8f → 1f, temporal ablation):
  ...
  2. [pipeline/LoadMultiViewImageFromMultiSweeps] sweeps_num=_num_frames_-1 → 0
     (자동 적용 — 별도 수정 불필요)
  3. [work_dir] sparseocc_eccv_r50_256x704_1f_wo_cam_mask_unified_rayiou
...
log_level = 'INFO'
work_dir = 'work_dirs/sparseocc_eccv_r50_256x704_1f_wo_cam_mask_unified_rayiou'
