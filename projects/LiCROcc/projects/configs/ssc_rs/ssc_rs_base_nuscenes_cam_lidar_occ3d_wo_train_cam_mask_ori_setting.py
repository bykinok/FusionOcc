...
#
# ssc_rs_base_nuscenes_cam_lidar_occ3d_wo_train_cam_mask.py
#
...
use_mask_camera = True         # 평가용 데이터셋: camera mask 유지
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        use_ego_frame=True,
        classes=class_names,
        use_mask_camera=use_mask_camera,  # 평가용: camera mask 유지
        use_mask_camera_1_2=use_mask_camera_1_2,
        use_mask_camera_1_4=use_mask_camera_1_4,
        use_mask_camera_1_8=use_mask_camera_1_8,
    ),
