...
work_dir = './work_dirs/ssc_rs_base_nuscenes_cam_radar_wo_train_cam_mask_unified'
...
model = dict(
   type='SSC_RS',
    ...
    temperature=1.9544,  # Temperature scaling (NLL-calibrated on val_calib) — update after tools/train_temperature.py
    img_backbone=dict(
        type='mmdet.ResNet',
        depth=50,
        num_stages=4,
