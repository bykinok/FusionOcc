...
#   - ALL free voxels: always supervised regardless of camera visibility.
#   - Occupied voxels: obey original mask_camera (invisible occupied → 255).
work_dir = './work_dirs/ssc_rs_base_nuscenes_cam_lidar_occ3d_unified_condition_D_full'
...
# condition_D_full: train dataset applies full-range free supervision
