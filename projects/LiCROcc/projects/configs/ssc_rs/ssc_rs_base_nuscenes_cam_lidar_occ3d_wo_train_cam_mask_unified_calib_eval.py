...
work_dir = './work_dirs/ssc_rs_base_nuscenes_cam_lidar_wo_train_cam_mask_unified'
...
model = dict(
    ...
    temperature=1.9484,  # Temperature scaling (NLL-calibrated on val_calib) — update after tools/train_temperature.py
    img_backbone=dict(
        type='mmdet.ResNet',
        depth=50,
        num_stages=4,
...
use_mask_camera_eval = True   # 평가 시 camera mask 사용
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        use_ego_frame=True,
        classes=class_names,
        use_mask_camera=use_mask_camera_eval,   # 평가 시 camera mask 사용 (True)
        use_mask_camera_1_2=use_mask_camera_1_2,
        use_mask_camera_1_4=use_mask_camera_1_4,
        use_mask_camera_1_8=use_mask_camera_1_8,
    ),
...
# 평가 시 camera mask 사용 (use_image_mask=True)
val_evaluator = [
    dict(
