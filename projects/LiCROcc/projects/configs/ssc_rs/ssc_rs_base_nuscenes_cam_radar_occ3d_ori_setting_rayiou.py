...
#
# ssc_rs_base_nuscenes_cam_radar_occ3d_ori_setting_rayiou.py
# Based on ssc_rs_base_nuscenes_cam_radar_occ3d_ori_setting.py
#
# Camera mask policy:
...
#
work_dir = './work_dirs/ssc_rs_base_nuscenes_cam_radar_occ3d_ori_setting_rayiou'
