...
#
# ssc_rs_base_nuscenes_cam_lidar_occ3d_unified_rayiou.py
# Based on ssc_rs_base_nuscenes_cam_lidar_occ3d_unified.py
#
# Camera mask policy:
#   - Training  : use_mask_camera=True  → GT에 255(ignore) 마스킹 → 카메라 가시 voxel에만 loss 계산
...
#
work_dir = './work_dirs/ssc_rs_base_nuscenes_cam_lidar_occ3d_unified_rayiou'
...
use_mask_camera = True        # 학습 시 camera mask 사용 (train dataloader)
