...
#   - ALL occupied voxels: always supervised regardless of camera visibility.
#   - Free voxels: obey original mask_camera (invisible free → 255).
work_dir = './work_dirs/ssc_rs_base_nuscenes_cam_lidar_occ3d_unified_condition_C_full'
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        empty_idx=17 if dataset_name == 'occ3d' else 0,
        fusion_cfg=[
...
# Baseline: use_mask_camera=True (for val/test; train overridden by mask_mode)
...
# condition_C_full: train dataset applies full-range occupied supervision
