...
#   - ALL occupied voxels: always supervised (set to gt label) regardless
...
# voxel_semantic_mask. condition_C_full is implemented in LoadOccupancy
# by forcing supervision for all occupied voxels.
