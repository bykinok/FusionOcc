...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=data_prefix,
        ann_file='occfrmwrk-nuscenes_infos_val_eval.pkl',
...
val_evaluator = dict(
    ...
    ann_file='data/nuscenes/occfrmwrk-nuscenes_infos_val_eval.pkl',
    data_root='data/nuscenes/',
    eval_metric='miou',
...
model = dict(
    ...
    temperature=1.9220,  # Temperature scaling (NLL-calibrated on val_calib) — update after tools/train_temperature.py
