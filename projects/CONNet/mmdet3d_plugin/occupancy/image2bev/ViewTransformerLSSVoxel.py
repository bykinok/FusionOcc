...
# from mmcv.runner import force_fp32  # Removed for mmengine compatibility
from torch.cuda.amp.autocast_mode import autocast
from ...utils.gaussian import generate_guassian_depth_target
...
class ViewTransformerLiftSplatShootVoxel(ViewTransformerLSSBEVDepth):
    ...
    def voxel_pooling(self, geom_feats, x):
        ...
        nx_z = int(self.nx[2].item())
        nx_x = int(self.nx[0].item())
        nx_y = int(self.nx[1].item())
        final = occ_pool(x, geom_feats, B, nx_z, nx_x, nx_y)  # ZXY
