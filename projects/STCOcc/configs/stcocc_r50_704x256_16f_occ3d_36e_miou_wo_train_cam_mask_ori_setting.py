...
#
# stcocc_r50_704x256_16f_occ3d_36e_miou_wo_train_cam_mask.py
#
# Based on stcocc_r50_704x256_16f_occ3d_36e_miou_ori_setting.py
#
# Camera mask policy:
#   - Training  : ignore_invisible=False → 비가시 voxel GT를 255로 마스킹하지 않음
#                 → 전체 voxel에 대해 loss 계산
#   - Evaluation: use_image_mask=True (OccupancyMetric) → 카메라 가시 voxel만 mIoU 계산
#
