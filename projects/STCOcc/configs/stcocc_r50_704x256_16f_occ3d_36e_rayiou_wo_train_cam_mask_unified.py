...
#
# stcocc_r50_704x256_16f_occ3d_36e_rayiou_wo_train_cam_mask_unified.py
#
...
#   - Evaluation: use_image_mask=False (OccupancyMetric) → RayIoU는 camera mask 불필요
#                 eval_metric='rayiou' → LiDAR ray 기반 평가
#
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        work_dir='stcocc_r50_704x256_16f_occ3d_36e_wo_train_cam_mask',
        eval_show=True))
