...
#
# stcocc_r50_704x256_16f_occ3d_36e_rayiou_wo_train_cam_mask_ori_setting.py
#
# Based on stcocc_r50_704x256_16f_occ3d_36e_miou_wo_train_cam_mask_ori_setting.py
#
# Camera mask policy:
...
train_pipeline = [
    ...
    dict(type='STCOccLoadOccGTFromFileCVPR2023', scale_1_2=True, scale_1_4=True, scale_1_8=True, load_mask=True, ignore_invisible=False),  # 학습 시 camera mask 미사용 → 전체 voxel에 loss 계산
