...
#   - Occupied voxels < 20 m from ego: always supervised (force mask=1)
...
#   condition_C_20m → occupied supervised 0–20 m only
#   condition_C     → occupied supervised 0–35 m
# -----------------------------------------------------------------------
...
# condition_C_20m: occupied voxels within 20 m are always supervised;
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        work_dir='stcocc_r50_704x256_16f_occ3d_36e_condition_C_20m',
        eval_show=True))
