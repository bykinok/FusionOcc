...
#   - Free voxels < 35 m from ego: always supervised (force mask=1)
...
# Condition D': free voxels within 35 m are always supervised;
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        work_dir='stcocc_r50_704x256_16f_occ3d_36e_condition_D_prime',
        eval_show=True))
