...
model = dict(
    ...
    bev_h=bev_w_,
    bev_z=bev_z,
    temperature=1.9376,  # Temperature scaling (NLL-calibrated on val_calib) — update after tools/train_temperature.py
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='data/nuscenes/stcocc-nuscenes_infos_val_eval.pkl',
