...
def nuscenes_get_rt_matrix(
        ...
        dest_mod):
    """
    Get transformation matrix from src to dest coordinate frame.
    
    Args:
        src_sample: Source sample info containing pose information
        dest_sample: Destination sample info containing pose information
        src_mod: Source modality (e.g., 'ego', 'lidar', 'global')
        dest_mod: Destination modality (e.g., 'ego', 'lidar', 'global')
    
    Returns:
        4x4 transformation matrix from src to dest
    """
