...
# Ensure CustormLearnedPositionalEncoding is imported and registered
from .bevformer_utils.positional_encoding import CustormLearnedPositionalEncoding
...
class BEVFormerBackwardProjection(BaseModule):
    ...
    # @force_fp32(apply_to=('mlvl_feats'))  # deprecated decorator
    def forward(self,
                mlvl_feats,
                img_metas,
                voxel_feats=None,
