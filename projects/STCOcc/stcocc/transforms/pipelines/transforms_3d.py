...
# from mmcv import is_tuple_of  # deprecated
def is_tuple_of(seq, expected_type):
    """Check whether it is a tuple of some type."""
    return isinstance(seq, tuple) and all(isinstance(x, expected_type) for x in seq)
from mmengine.registry import build_from_cfg

# from mmdet3d.core import VoxelGenerator  # module not available
try:
    from mmdet3d.datasets.transforms import VoxelGenerator
except ImportError:
    VoxelGenerator = None  # fallback
from mmdet3d.structures.bbox_3d import (CameraInstance3DBoxes, DepthInstance3DBoxes,
                               LiDARInstance3DBoxes)
from mmdet3d.structures.ops import box_np_ops
from .compose import Compose
# from mmdet.datasets.pipelines import RandomCrop, RandomFlip, Rotate  # module not available
