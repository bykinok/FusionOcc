...
# Helper function to replace is_list_of
def is_list_of(seq, expected_type):
    """Check whether a sequence is a list of objects of the expected type."""
...
@TRANSFORMS.register_module(name='STCOccMultiScaleFlipAug3D')
