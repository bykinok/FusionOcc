...
#   - Evaluation: use_image_mask=True → mIoU is computed only on camera-visible voxels
#
# This matches the "wo_train_cam_mask" convention used in LiCROcc configs.
...
# 평가 시 camera mask 사용 (use_image_mask=True) → 카메라에 보이는 voxel만 mIoU 계산
val_evaluator = dict(
