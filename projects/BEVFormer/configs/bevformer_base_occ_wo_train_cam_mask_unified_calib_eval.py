...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        temperature=1.8684,  # Temperature scaling (NLL-calibrated on val_calib)
        loss_occ= dict(
...
data = dict(
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file='occ_infos_temporal_val_eval.pkl',
...
val_evaluator = dict(
    ...
    ann_file='data/nuscenes/occ_infos_temporal_val_eval.pkl',
    data_root='data/nuscenes/',
