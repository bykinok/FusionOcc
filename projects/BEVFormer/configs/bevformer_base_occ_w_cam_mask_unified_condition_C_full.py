...
# so condition_C_full is implemented by forcing mask_camera=1 for all
# occupied voxels in LoadOccGTFromFile.
...
work_dir = './work_dirs/bevformer_base_occ_w_cam_mask_unified_condition_C_full'
