...
# Import xavier_init and constant_init with fallback
try:
...
try:
    ...
    def build_attention(cfg):
        ...
        return ENGINE_MODELS.build(cfg)

# Register with mmengine
...
try:
    ...
    MultiScaleDeformableAttnFunction_fp16 = None
