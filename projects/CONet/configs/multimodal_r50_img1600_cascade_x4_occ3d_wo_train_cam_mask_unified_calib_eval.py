...
val_ann_file = "nuscenes_occ_infos_val_eval.pkl"
...
visible_mask_eval = True    # 평가 시 camera mask 사용
...
model = dict(
    ...
    temperature=1.8387,  # Temperature scaling (NLL-calibrated on val_calib) — update after tools/train_temperature.py
...
test_pipeline = [
    ...
    dict(type='LoadOccupancy', 
         ...
         use_occ3d=use_occ3d,
         use_camera_mask=visible_mask_eval),  # 평가 시 camera mask 사용 (True)
