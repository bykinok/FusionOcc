...
#   - ALL free voxels: always supervised (gt label kept) regardless
#     of camera visibility, at every distance from ego.
#   - Occupied voxels: obey original mask_camera (invisible occupied → 255).
#
# CONet sets non-supervised voxels to 255 (ignore) in gt_occ.
# condition_D_full is implemented in LoadOccupancy._apply_mask.
