...
#
# multimodal_r50_img1600_cascade_x4_occ3d_unified_rayiou.py
#
# Based on multimodal_r50_img1600_cascade_x4_occ3d_unified.py
#
# Camera mask policy:
#   - Training  : use_camera_mask=True  → GT에 255(ignore) 마스킹 → 카메라 가시 voxel에만 loss 계산
...
test_pipeline = [
    ...
    dict(type='LoadOccupancy', 
         ...
         cal_visible=visible_mask,
         use_occ3d=use_occ3d,
         use_camera_mask=False),  # RayIoU: GT 마스킹 없이 원본 voxel label 유지
