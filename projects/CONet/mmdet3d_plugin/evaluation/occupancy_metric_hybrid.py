"""OccupancyMetricHybrid for CONet using STCOcc metric for occ3d GT format."""
import numpy as np
import torch
...
class OccupancyMetricHybrid(BaseMetric):
    """Occupancy Metric for CONet using STCOcc's metric for occ3d format.
    ...
    def __init__(self, 
        ...
        # This file is in: projects/CONet/mmdet3d_plugin/evaluation/occupancy_metric_hybrid.py
