...
class LoadPointsFromFile(object):
    ...
    def __call__(self, results):
        ...
        points = points_class(
            points, points_dim=points.shape[-1], attribute_dims=attribute_dims)
        results['points'] = points
        results['curr_points'] = points_class(
            pt_tensor.copy(), points_dim=points.shape[-1], attribute_dims=attribute_dims)
        return results
        ...
        for cam_idx, cam_name in enumerate(cam_names):
            ...
            img, post_rot2, post_tran2 = \
                self.img_transform(img, post_rot,
                                   ...
                                   flip=flip,
                                   rotate=rotate)
            seg = self.seg_transform_core(seg, resize_dims, crop, flip, rotate)
            ...
            canvas_segs.append(np.array(seg))
